package com.product.managefund.CustomView
...
class CustomChart : View {
    ...
    private fun initialize(attrs: AttributeSet?) {
        ...
        val graph1 = floatArrayOf(0f, 0f)
        val graph2 = floatArrayOf(0f, 0f)

        val arrGraph = ArrayList<ChartEntity>().apply {
            add(ChartEntity(R.color.green_50, graph1))
            add(ChartEntity(R.color.violet_50, graph2))
        }
